    ...
    function initHomeHeroSlider() {
        ...
        if (!hero || !track || !prevBtn || !nextBtn || !dotsEl) {
            if (DEBUG) console.warn('⚠️ HOMEスライダー要素が足りないので初期化中断');
            return;
        }
        ...
        if (!slides || slides.length <= 1) {
            if (DEBUG) console.warn('⚠️ スライド枚数が1枚以下です');
        ...
        const pages = {
            ...
            'price-mod-frame': `
                <div class="yc-price-table-page">
                    ...
                    <div id="yc-frame-price-table"></div>
    ...
    const worksData = [
        ...
        },
        {
            ...
            `${GH}/700c_Mixte_for_S-1-03.jpg`,
            `${GH}/700c_Mixte_for_S-1-04.jpg`,
            `${GH}/700c_Mixte_for_S-1-05.jpg`,
            `${GH}/700c_Mixte_for_S-1-06.jpg`,
            `${GH}/700c_Mixte_for_S-1-07.jpg`,
            `${GH}/700c_Mixte_for_S-1-08.jpg`,
            `${GH}/700c_Mixte_for_S-1-09.jpg`,
            `${GH}/700c_Mixte_for_S-1-10.jpg`
            ],
        },
        {
            ...
            `${GH}/Adventure_Bike_for_I-05.jpg`,
            `${GH}/Adventure_Bike_for_I-06.jpg`,
            `${GH}/Adventure_Bike_for_I-07.jpg`,
            `${GH}/Adventure_Bike_for_I-08.jpg`
            ],
        },
        {
            ...
            `${GH}/Gravel_Bike_for_N-03.jpg`,
            `${GH}/Gravel_Bike_for_N-04.jpg`,
            `${GH}/Gravel_Bike_for_N-05.jpg`,
            `${GH}/Gravel_Bike_for_N-06.jpg`,
            `${GH}/Gravel_Bike_for_N-07.jpg`,
            `${GH}/Gravel_Bike_for_N-08.jpg`,
        ...
        },
        {
            ...
            `${GH}/Commuter_for_I-03.jpg`,
            `${GH}/Commuter_for_I-04.jpg`,
            `${GH}/Commuter_for_I-05.jpg`,
            `${GH}/Commuter_for_I-06.jpg`,
            `${GH}/Commuter_for_I-07.jpg`,
            `${GH}/Commuter_for_I-08.jpg`,
            `${GH}/Commuter_for_I-09.jpg`,
            `${GH}/Commuter_for_I-10.jpg`
            ],
        },
        {
            ...
            `${GH}/Quiet_Disc_for_S-03.jpg`,
            `${GH}/Quiet_Disc_for_S-04.jpg`,
            `${GH}/Quiet_Disc_for_S-05.jpg`,
            `${GH}/Quiet_Disc_for_S-06.jpg`,
            `${GH}/Quiet_Disc_for_S-07.jpg`,
            `${GH}/Quiet_Disc_for_S-08.jpg`,
            `${GH}/Quiet_Disc_for_S-09.jpg`
            ],
        },
        {
            slug: 'kokuo',
    ...
    function router() {
        ...
        if (pageKey === 'works') {
            ...
            if (pageKey === 'price-mod-bike') {
                loadPriceTable({
                    containerSelector: '#yc-bike-sport-table',
                    type: 'bike_sport',
                    tableClass: 'yc-price-table-scroll yc-price-table-scroll-bike yc-price-table-scroll-bike-sport'
                });

                loadPriceTable({
                    containerSelector: '#yc-bike-city-table',
                    type: 'bike_city',
                    tableClass: 'yc-price-table-scroll yc-price-table-scroll-bike yc-price-table-scroll-bike-city'
                });
            }
